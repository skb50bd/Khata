...
namespace Khata.Data.Persistence.Migrations
{
    ...
    [Migration("20181228193729_RemodeledSale")]
    partial class RemodeledSale
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Khata.Domain.LineItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Khata.Domain.LineItem", b =>
                {
                    ...
                    b.OwnsOne("Khata.Domain.Pricing", "Pricing", b1 =>
                        {
                            ...
                            b1.HasOne("Khata.Domain.LineItem")
                                .WithOne("Pricing")
                                .HasForeignKey("Khata.Domain.Pricing", "LineItemId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
