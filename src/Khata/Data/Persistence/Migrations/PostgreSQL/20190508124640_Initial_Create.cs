        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Payment_SubTotal = table.Column<decimal>(type: "decimal(18, 6)", nullable: false),
                    Payment_DiscountCash = table.Column<decimal>(type: "decimal(18, 6)", nullable: false),
                    Payment_Paid = table.Column<decimal>(type: "decimal(18, 6)", nullable: false),
                    Description = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OutletId = table.Column<int>(nullable: false),
                    Description = table.Column<string>(nullable: true),
                    Inventory_Stock = table.Column<decimal>(type: "decimal(18, 6)", nullable: false),
                    Inventory_Warehouse = table.Column<decimal>(type: "decimal(18, 6)", nullable: false),
                    Inventory_AlertAt = table.Column<decimal>(type: "decimal(18, 6)", nullable: false),
                    Unit = table.Column<string>(nullable: true),
                    Price_Purchase = table.Column<decimal>(type: "decimal(18, 6)", nullable: false),
                    Price_Retail = table.Column<decimal>(type: "decimal(18, 6)", nullable: false),
                    Price_Bulk = table.Column<decimal>(type: "decimal(18, 6)", nullable: false),
                    Price_Margin = table.Column<decimal>(type: "decimal(18, 6)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaleId = table.Column<int>(nullable: true),
                    SavedSaleId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
